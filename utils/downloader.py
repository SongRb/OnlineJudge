...
class Downloader:
    ...
    def save_solution_file(self, problem_set, file_name, code_type, code):
        ...
        with open("{0}/{1}-{2}.{3}".format(self.path, self.title2id[file_name], file_name, code_type), 'w', encoding='utf8') as file_:
            file_.write(code)
    ...
    def __init__(self):
        ...
        self.title2id = {stat['stat']['question__title']:stat['stat']['frontend_question_id']  for stat in self.questions}
